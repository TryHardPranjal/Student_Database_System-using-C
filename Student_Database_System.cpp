...
class student
{
	...
	double per;
	char grade;    // doesn't work don't know why
	void calculate();	
public:
	void getdata();		
	void showdata() const;	
...
void student::calculate()
{
	...
	if(per>=90.0)
		grade='O';
	else if(per<80.0 && per>=75.0)
		grade='A';
	else if(per<75.0 && per>=70.0)
		grade='B';
	else if(per<70.0 && per>=65.0)
		grade='C';
	else if(per<65.0 && per>=60.0)
		grade='D';
	else if(per<60.0 && per>=55.0)
		grade='E';
	else if(per<55.0 && per>=50.0)
		grade='G';
	// else if(per<50.0)
	// 	grade='F';
	else
...
{
	cout<<idnum<<setw(7)<<" "<<name<<setw(6)<<physics<<setw(5)<<chemistry<<setw(4)<<mathematics<<setw(5)
		<<english<<setw(6)<<comscience<<setw(10)<<per<<setw(12)<<grade<<endl;
}
...
void class_result()
{
	...
	cout<<"\n\n\t\tALL STUDENTS RESULT \n\n";
	cout<<"==========================================================\n";
	cout<<"R.No    Name             P    C    M    E    CS   Percentage    Grade"<<endl;
	cout<<"==========================================================\n";
	while(inFile.read(reinterpret_cast<char *> (&st), sizeof(student)))
	{
		st.show_tabular();
